...
public class ModEffects {
    ...
    private static final RegistryObject<MobEffect> ATTACK_CONFUSION = MOB_EFFECTS.register("attack_nausea", () -> new AttackMobEffect(MobEffects.CONFUSION, MobEffects.CONFUSION.get().getColor()));
    ...
    private static final RegistryObject<MobEffect> ATTACK_DIG_SLOWDOWN = MOB_EFFECTS.register("attack_mining_fatigue", () -> new AttackMobEffect(MobEffects.DIG_SLOWDOWN, MobEffects.DIG_SLOWDOWN.get().getColor()));
    ...
    private static final RegistryObject<MobEffect> ATTACK_HARM = MOB_EFFECTS.register("attack_instant_damage", () -> new AttackMobEffect(MobEffects.HARM, MobEffects.HARM.get().getColor()));
    ...
    private static final RegistryObject<MobEffect> ATTACK_MOVEMENT_SLOWDOWN = MOB_EFFECTS.register("attack_slowness", () -> new AttackMobEffect(MobEffects.MOVEMENT_SLOWDOWN, MobEffects.MOVEMENT_SLOWDOWN.get().getColor()));
