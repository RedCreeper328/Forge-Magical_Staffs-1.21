...
public class ModEffects {
    ...
    public static final RegistryObject<MobEffect> ATTACK_INFESTED = MOB_EFFECTS.register("attack_infested", () -> new AttackMobEffect(MobEffects.INFESTED, MobEffects.INFESTED.get().getColor()));
    ...
    public static final RegistryObject<MobEffect> ATTACK_OOZING = MOB_EFFECTS.register("attack_oozing", () -> new AttackMobEffect(MobEffects.OOZING, MobEffects.OOZING.get().getColor()));
    ...
    public static final RegistryObject<MobEffect> ATTACK_WEAVING = MOB_EFFECTS.register("attack_weaving", () -> new AttackMobEffect(MobEffects.WEAVING, MobEffects.WEAVING.get().getColor()));
    public static final RegistryObject<MobEffect> ATTACK_WIND_CHARGED = MOB_EFFECTS.register("attack_wind_charged", () -> new AttackMobEffect(MobEffects.WIND_CHARGED, MobEffects.WIND_CHARGED.get().getColor()));
